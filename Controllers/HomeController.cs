...
namespace Backoffice.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            var employee = new User { Id = 1, Username = "robin", Password = "robin", Role = "employee" }; //id fixo para adicionar somente uma vez
            var manager = new User { Id = 2, Username = "batman", Password = "batman", Role = "manager" };
            var category = new Category { Id = 1, Title = "Informática" };
            var product = new Product { Id = 1, Category = category, Title = "Mouse", Price = 199, Description = "Mouse Gamer" };
